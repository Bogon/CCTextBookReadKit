//
//  CCBRKSegmentedControl.m
//  CCBRKSegmentedControl
//
//  Created by mac on 2019/8/15.
//

#import "CCBRKSegmentedControl.h"

@interface CCBRKSegmentedControl()
...
@implementation CCBRKSegmentedControl
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.sliderHeight = 2;
        self.sliderBottom = 0;
        self.sliderWidth = CCBRKSegmentedControlSliderWidthFill;
        self.itemSpace = 0;
...
- (void)scrollIndex:(NSInteger)index animated:(BOOL)animated {
    ...
    if (animated) {
        ...
        __weak CCBRKSegmentedControl *weakSelf = self;

//
//  CCBRKValueTrackingSlider.m
//  CCBRKValuePopUpView
//
//  Created by mac on 2019/8/15.
//

#import "CCBRKValueTrackingSlider.h"
#import "CCBRKValuePopUpView.h"

@interface CCBRKValueTrackingSlider() <CCBRKValuePopUpViewDelegate>
@property (strong, nonatomic) CCBRKValuePopUpView *popUpView;
@property (nonatomic) BOOL popUpViewAlwaysOn; // default is NO
@end


@implementation CCBRKValueTrackingSlider
{
...
- (void)setup
{
    ...
    self.popUpView = [[CCBRKValuePopUpView alloc] initWithFrame:CGRectZero];

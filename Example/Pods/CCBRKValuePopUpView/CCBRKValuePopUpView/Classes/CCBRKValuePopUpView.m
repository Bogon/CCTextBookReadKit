...
@implementation CALayer (CCBRKAnimationAdditions)
...
#define SliderFillColorAnim @"fillColor"

#if __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_10_0
@interface CCBRKValuePopUpView () <CAAnimationDelegate>
@end
#endif

@implementation CCBRKValuePopUpView
{
    BOOL _shouldAnimate;

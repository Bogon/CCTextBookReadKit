...
@protocol CCBRKValueTrackingSliderDelegate;
@protocol CCBRKValueTrackingSliderDataSource;

@interface CCBRKValueTrackingSlider : UISlider
...
@property (weak, nonatomic) id<CCBRKValueTrackingSliderDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<CCBRKValueTrackingSliderDelegate> delegate;
@end
...
@protocol CCBRKValueTrackingSliderDataSource <NSObject>
- (NSString *)slider:(CCBRKValueTrackingSlider *)slider stringForValue:(float)value;
@end
...
@protocol CCBRKValueTrackingSliderDelegate <NSObject>
- (void)sliderWillDisplayPopUpView:(CCBRKValueTrackingSlider *)slider;

@optional
- (void)sliderWillHidePopUpView:(CCBRKValueTrackingSlider *)slider;
- (void)sliderDidHidePopUpView:(CCBRKValueTrackingSlider *)slider;

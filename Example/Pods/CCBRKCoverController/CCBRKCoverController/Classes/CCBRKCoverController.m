...
#import "CCBRKCoverController.h"

@interface CCBRKCoverController ()<UIGestureRecognizerDelegate>
...
@implementation CCBRKCoverController
    ...
    if (self.pendingController) {
        ...
        if (self.isLeft) { // 左边
            ...
            if (animated) {
                ...
                __weak CCBRKCoverController *weakSelf = self;

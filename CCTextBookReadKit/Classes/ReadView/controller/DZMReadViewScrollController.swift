...
public class DZMReadViewScrollController: DZMViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    // 开始减速
    private func scrollViewWillBeginDecelerating(_ scrollView: UIScrollView) {

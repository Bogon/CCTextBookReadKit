...
/// 主题颜色
public var DZM_READ_COLOR_MAIN:UIColor = DZM_COLOR_253_85_103

/// 菜单默认颜色
public var DZM_READ_COLOR_MENU_COLOR:UIColor = DZM_COLOR_230_230_230

/// 菜单背景颜色
public var DZM_READ_COLOR_MENU_BG_COLOR:UIColor = DZM_COLOR_46_46_46.withAlphaComponent(0.95)

/// 阅读背景颜色列表
public let DZM_READ_BG_COLORS:[UIColor] = [UIColor.white, DZM_COLOR_238_224_202, DZM_COLOR_205_239_205, DZM_COLOR_206_233_241, DZM_COLOR_58_52_54, DZM_COLOR_BG_0]
...
/// 阅读最小阅读字体大小
public let DZM_READ_FONT_SIZE_MIN:NSInteger = 12

/// 阅读最大阅读字体大小
public let DZM_READ_FONT_SIZE_MAX:NSInteger = 24

/// 阅读默认字体大小
public let DZM_READ_FONT_SIZE_DEFAULT:NSInteger = 18

/// 阅读字体大小叠加指数
public let DZM_READ_FONT_SIZE_SPACE:NSInteger = 2

/// 章节标题 - 在当前字体大小上叠加指数
public let DZM_READ_FONT_SIZE_SPACE_TITLE:NSInteger = 8

/// 单利对象
private var configure:DZMReadConfigure?

public class DZMReadConfigure: NSObject {
    ...
    var bgColor:UIColor! {
        ...
        if bgColorIndex.intValue == DZM_READ_BG_COLORS.index(of: DZM_COLOR_BG_0) { // 牛皮黄背景
            ...
            return UIColor(patternImage: UIImage(named: "\(IconPath(WithIconName: "read_bg_0"))")!)

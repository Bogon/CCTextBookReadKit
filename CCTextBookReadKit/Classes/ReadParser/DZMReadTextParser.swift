...
public class DZMReadTextParser: NSObject {
    ...
    ///   - url: 本地文件地址
    ///   - completion: 解析完成
    @objc public  class func parser(url:URL!, completion:DZMParserCompletion!) {
    ...
    /// - Returns: 阅读对象
    public class func parser(url:URL!) ->DZMReadModel? {
    ...
    ///   - content: 小说内容
    /// - Returns: 章节列表
    public class func parser(bookID:String!, content:String!) ->[DZMReadChapterListModel] {

...
class DZMRMLightView: DZMRMBaseView {
    ...
    override func addSubviews() {
        ...
        leftIcon.image = UIImage(named: "\(IconPath(WithIconName: "light_0"))")!.withRenderingMode(.alwaysTemplate)
        leftIcon.tintColor = DZM_READ_COLOR_MENU_COLOR
        addSubview(leftIcon)
        
        rightIcon = UIImageView()
        rightIcon.image = UIImage(named: "\(IconPath(WithIconName: "light_1"))")!.withRenderingMode(.alwaysTemplate)

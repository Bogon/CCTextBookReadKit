...
class DZMRMTopView: DZMRMBaseView {
    ...
    override func addSubviews() {
        ...
        back.setImage(UIImage(named:"\(IconPath(WithIconName: "back"))")!.withRenderingMode(.alwaysTemplate), for: .normal)
        ...
        mark.setImage(UIImage(named:"\(IconPath(WithIconName: "mark"))")!.withRenderingMode(.alwaysTemplate), for: .normal)

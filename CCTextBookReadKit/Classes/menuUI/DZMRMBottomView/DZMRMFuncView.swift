...
class DZMRMFuncView: DZMRMBaseView {
    ...
    override func addSubviews() {
        ...
        catalogue.setImage(UIImage(named:"\(IconPath(WithIconName: "bar_0"))")?.withRenderingMode(.alwaysTemplate), for: .normal)
        ...
        dn.setImage(UIImage(named:"\(IconPath(WithIconName: "bar_2"))")!.withRenderingMode(.alwaysTemplate), for: .normal)
        ...
        setting.setImage(UIImage(named:"\(IconPath(WithIconName: "bar_1"))")!.withRenderingMode(.alwaysTemplate), for: .normal)
